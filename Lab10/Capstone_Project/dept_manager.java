...
//
// Debug information:
// Generated date: Mon Nov 25 20:43:59 ICT 2024
...
public class dept_manager extends SqoopRecord  implements DBWritable, Writable {
  ...
  private void init0() {
    setters.put("dept_no", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        dept_manager.this.dept_no = (String)value;
      }
    });
    setters.put("emp_no", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        dept_manager.this.emp_no = (Integer)value;
      }
    });
  }
  public dept_manager() {
  ...
  public void readFields(ResultSet __dbResults) throws SQLException {
    ...
    this.emp_no = JdbcWritableBridge.readInteger(2, __dbResults);
  }
  ...
  public int write(PreparedStatement __dbStmt, int __off) throws SQLException {
    JdbcWritableBridge.writeString(dept_no, 1 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeInteger(emp_no, 2 + __off, 4, __dbStmt);
    return 2;
  }
