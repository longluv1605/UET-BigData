...
departments = spark.table('capstone_proj_cap.departments')
departments.createOrReplaceTempView('departments')

titles = spark.table('capstone_proj_cap.titles')
titles.createOrReplaceTempView('titles')

employees = spark.table('capstone_proj_cap.employees')
...
dept_emp_raw = spark.table('capstone_proj_cap.dept_emp')
dept_emp = spark.table('capstone_proj_cap.dept_emp1')
dept_emp.createOrReplaceTempView('dept_emp')

dept_manager = spark.table('capstone_proj_cap.dept_manager')
dept_manager.createOrReplaceTempView('dept_manager')

salaries = spark.table('capstone_proj_cap.salaries')
